...
abstract class UpdateMessageDigestInputStream extends InputStream {
	 ...
	 * <p>
	 * Using this method is more optimized since it avoids creating new byte
	 * arrays for each call.
	 * 
	 * @param messageDigest
	 ...
	 *            the message digest to update
	 * @param len
	 *            how many bytes to read from this stream and use to update the
	 *            message digest
	 * @throws IOException
	 *             when propagated from {@link #read()}
	 */
